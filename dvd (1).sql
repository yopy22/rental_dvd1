...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2018 at 11:24 AM
...
--
-- Table structure for table `tb_t_barang_keluar`
--

CREATE TABLE `tb_t_barang_keluar` (
...
--
-- Dumping data for table `tb_t_barang_keluar`
--

INSERT INTO `tb_t_barang_keluar` (`id_transaksi`, `no_transaksi`, `id_dvd`, `tanggal_pinjam`, `tanggal_harus_kembali`, `id_admin`, `id_peminjam`, `qty_pinjam`, `kodepromo`, `keterangan`) VALUES
(2, 'TR-1', 'DVD-1', '2018-06-04 00:00:00', '2018-06-07 00:00:00', 'adm1', 'US-1', 2, '', ''),
(3, 'TR-1', 'DVD-1', '2018-06-04 00:00:00', '2018-06-07 00:00:00', 'adm1', 'US-1', 2, '', ''),
(4, 'TR-1', 'DVD-1', '2018-06-04 00:00:00', '2018-06-07 00:00:00', 'adm1', 'US-1', 2, '', ''),
(5, 'TR-1', 'DVD-1', '2018-06-04 00:00:00', '2018-06-07 00:00:00', 'adm1', 'US-1', 2, '', ''),
(6, 'TR-1', 'DVD-1', '2018-06-04 00:00:00', '2018-06-14 00:00:00', 'adm1', 'US-1', 3, '', ''),
(9, 'TR-1', 'DVD-1', '2018-06-04 00:00:00', '2018-06-14 00:00:00', 'adm1', 'US-1', 3, '', '');
...
('DVD-1', 'TEST', 'sinopsis', '2018-05-16', 'S-1', 0, 'img/gallery/DVD-1.gif', 10002, 'G-1', 'adm1');
...
--
-- Dumping data for table `tb_t_promo`
--

INSERT INTO `tb_t_promo` (`kodepromo`, `nama_promo`, `keterangan`, `discount`, `tgl_promo_mulai`, `tgl_promo_selesai`) VALUES
('qwert', 'qwert', 'qwerty', 10, '2018-05-23 01:00:00', '2018-05-25 00:00:00');
...
--
-- Indexes for table `tb_t_barang_keluar`
--
ALTER TABLE `tb_t_barang_keluar`
...
--
-- AUTO_INCREMENT for table `tb_t_barang_keluar`
--
ALTER TABLE `tb_t_barang_keluar`
...
--
-- Constraints for table `tb_t_barang_keluar`
--
ALTER TABLE `tb_t_barang_keluar`
  ADD CONSTRAINT `tb_t_barang_keluar_ibfk_1` FOREIGN KEY (`id_dvd`) REFERENCES `tb_t_dvd` (`id_dvd`),
  ADD CONSTRAINT `tb_t_barang_keluar_ibfk_2` FOREIGN KEY (`id_peminjam`) REFERENCES `tb_m_user` (`id_user`),
  ADD CONSTRAINT `tb_t_barang_keluar_ibfk_3` FOREIGN KEY (`id_admin`) REFERENCES `tb_m_admin` (`id_admin`);

--
-- Constraints for table `tb_t_barang_masuk`
--
ALTER TABLE `tb_t_barang_masuk`
  ADD CONSTRAINT `tb_t_barang_masuk_ibfk_1` FOREIGN KEY (`id_transaksi`) REFERENCES `tb_t_barang_keluar` (`id_transaksi`),
